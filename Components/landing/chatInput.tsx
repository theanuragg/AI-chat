...
const ChatInput: React.FC<ChatInputProps> = ({
  ...
  return (
    ...
    >
      {/* Main input container with increased height */}
      <div className="p-4 sm:p-4 lg:p-4">
        {/* Mobile Layout - Horizontal */}
        <div className="flex items-center space-x-3 sm:space-x-2 lg:hidden">
          {/* Debate Button */}
        ...
        {/* Desktop Layout - Vertical: Input at top, buttons at bottom */}
        <div className="hidden lg:flex lg:flex-col lg:space-y-2">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="relative group flex-shrink-0">
              ...
              {/* Tooltip */}
              <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-3 flex-col opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 flex items-center z-20">
                <div className="bg-popover border border-border text-popover-foreground text-sm font-mono px-4 py-3 rounded-lg shadow-lg whitespace-nowrap">
                  About
                </div>
                <div className="w-3 h-3 bg-popover border-r border-b border-border rotate-45 -mt-2"></div>
              </div>
            </div>
